...
#if (CHIP_SYSTEM_CONFIG_USE_SOCKETS || CHIP_SYSTEM_CONFIG_USE_NETWORK_FRAMEWORK) && !CHIP_SYSTEM_CONFIG_USE_FREERTOS_SOCKETS
...
#if CHIP_SYSTEM_CONFIG_USE_SOCKETS && (defined(__ZEPHYR__) || CHIP_SYSTEM_CONFIG_USE_FREERTOS_SOCKETS)
...
#if CHIP_SYSTEM_CONFIG_USE_SOCKETS && !CHIP_SYSTEM_CONFIG_USE_ZEPHYR_SOCKETS && !CHIP_SYSTEM_CONFIG_USE_FREERTOS_SOCKETS
